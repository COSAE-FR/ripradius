module github.com/COSAE-FR/ripradius

go 1.17

require (
	github.com/COSAE-FR/riputils v1.5.0
...
require (
	...
	gopkg.in/hlandau/easyconfig.v1 v1.0.18 // indirect
	gopkg.in/hlandau/service.v2 v2.0.17 // indirect
